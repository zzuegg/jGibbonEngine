...
---
layout: page
title: "Assimp Asset Loader"
description: "Asset loading via Assimp — imports 40+ 3D model formats (OBJ, FBX, glTF, etc.) through Java FFM bindings."
---

<span class="index-card-label">Provider</span>
