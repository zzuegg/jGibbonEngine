...
public class TeaVmShaderCompiler implements ShaderCompiler {
    ...
    public CompileResult compileWithTypeMap(String source, List<EntryPointDesc> entryPoints,
        ...
        // TeaVM Slang WASM does not support generic specialization directly.
        // The type specialization is prepended as source by ShaderManager,
        // so we can just compile the modified source as-is.
