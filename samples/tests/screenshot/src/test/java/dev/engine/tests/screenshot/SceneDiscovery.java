...
class SceneDiscovery {
    ...
    record DiscoveredScene(String category, String name, RenderTestScene scene, Tolerance tolerance) {}
    record DiscoveredComparison(String category, String name, ComparisonTest test) {}
    ...
    List<DiscoveredScene> scenes() { return scenes; }
    List<DiscoveredComparison> comparisons() { return comparisons; }
