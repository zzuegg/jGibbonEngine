 ...
 *
 * <p>Args: {@code <manifestPath> <outputDir> <referencesDir> <profile> [sceneFilter]}
 */
public class DesktopRunnerMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        var sceneFilter = args.length > 4 ? args[4] : null;

        var config = new RunnerConfig(30_000, profile, outputDir, referencesDir, sceneFilter);
